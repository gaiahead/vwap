...
Detail shows facts with field-level citations/dates, top ten holdings when available, exact VWAP lines and estimated Volume Profile. Some holdings snapshots contain only the top ten; do not describe them as a complete portfolio. Top-ten concentration is the sum of the ten disclosed weights, rounded at source precision; it is unavailable if fewer than ten weighted holdings were supplied.
