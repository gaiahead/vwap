...
The list ends with 20-day average volume. It shows name/ticker, category, AUM, average trading value and average volume. Issuer remains searchable and filterable but is not a list column. Average trading value and average volume are displayed as rounded integers. Detail basic facts still show issuer and add benchmark and exposure. Fees, premium/discount and holdings summaries are not basic-fact columns. The detail begins with the VWAP chart, followed by basic facts and up to ten direct stock holdings with weights. PBR and PER are not collected, generated or displayed. Missing values display a dash.
